...
$activeCompany = isset($_REQUEST['media']) ? $_REQUEST['media'] : null;
$arrFilter["PROPERTY_PHOTO_VIDEO"] = $activeCompany;
...
<div class="last-news__filter">
    ...
    <div class="last-news__filter-media">

        <? if ($_GET['media'] == 28) {
            $activeClassPhoto = 'active';
        } elseif ($_GET['media'] == 29) {
            $activeClassVideo = 'active';

        } else {
//            $activeClassDefault = 'active';
        } ?>

        <a href="<?= add_url_get(array('media' => 29)); ?>" class="last-news__filter-video <?=$activeClassVideo?>"><span>Видео</span></a>

        <a href="<?= add_url_get(array('media' => 28)); ?>" class="last-news__filter-photo <?=$activeClassPhoto?>"><span>Фото</span></a>
