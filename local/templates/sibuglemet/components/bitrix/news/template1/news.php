...
<ul class="last-news__tags">
    ...
    <li><a class="<? if ( empty($_GET['tags']) ){ echo 'active';} ?>" href="<?= add_url_get(array('tags' => '')); ?>">#Все</a></li>
    
    <? $property_enums = CIBlockPropertyEnum::GetList(Array("DEF" => "DESC", "SORT" => "ASC"), Array("IBLOCK_ID" => $arResult["ID"], "CODE" => "TAGS"));
